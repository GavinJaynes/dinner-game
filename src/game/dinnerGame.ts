...
import type { GameState, DinnerOption, Player } from "./types";
...
export class DinnerGame {
  ...
  private showCurrentPlayerTurn(): void {
    ...
    const currentPlayerInstructions = document.getElementById(
  ...
  private updateCardSelection(): void {
    const cards = document.querySelectorAll(
      "#currentPlayerCards .dinner-card"
  ...
  private updateSelectedDisplay(): void {
    ...
    const selected =
      this.state[`player${this.state.currentPlayer}`].selectedCard;
  ...
  private checkConfirmButton(): void {
    ...
    const hasSelection =
      this.state[`player${this.state.currentPlayer}`].selectedCard !== null;
